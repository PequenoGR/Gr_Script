...
Dex++ Traduzido PT-BR
Versão traduzida automaticamente por ChatGPT
...
local function main()
	...
	G2L["6"]["PlaceholderText"] = [[Executar comando]];
	...
	G2L["1c"] = Instance.new("LocalScript", ConsoleFrame);
	...
	Console.Init = function()
		...
		local OutputTextSize = G2L["a"].OutputTextSize
		...
		Console.AutoScroll.MouseButton1Click:Connect(function()
			...
			if AutoScroll == true then
				Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(11, 90, 175)
				G2L["a"].CanvasPosition = Vector2.new(0, 9e9)
			elseif AutoScroll == false then
				Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(56, 56, 56)
			end
		end)
		...
		local OutputLimit = G2L["a"].OutputLimit
		...
		G2L["a"].MouseEnter:Connect(function()
			scrollConsoleInput = UserInputService.InputChanged:Connect(function(input)
				if CtrlScroll and input.UserInputType == Enum.UserInputType.MouseWheel and IsHoldingCTRL == true then
					...
					G2L["a"].ScrollingEnabled = true
				end
			end)
		end)
		G2L["a"].MouseLeave:Connect(function()
		...
		Console.Clear.MouseButton1Click:Connect(function()
			for _, log in pairs(G2L["a"]:GetChildren()) do
		...
		LogService.MessageOut:Connect(function(msg, msgtype)
			...
			local newOutputText = G2L["17"]:Clone()

...
local function main()
	...
	G2L["6"]["PlaceholderText"] = [[Executar um comando]];
	...
	G2L["11"]["PlaceholderText"] = [[Tamanho]];
	...
	G2L["1e"]["Text"] = [[Rolagem Automática]];
	...
	Console.Init = function()
		...
		if Console and Console:FindFirstChild("Limpar") then
...
local function main()
	...
	Explorer.InitRightClick = function()
		...
		context:Register("CUT",{Name = "Recortar", IconMap = Explorer.MiscIcons, Icon = "Cut", DisabledIcon = "Cut_Disabled", Shortcut = "Ctrl+Z", OnClick = function()
		...
		context:Register("COPY",{Name = "Copiar", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+C", OnClick = function()
		...
		context:Register("PASTE",{Name = "Colar Em", IconMap = Explorer.MiscIcons, Icon = "Paste", DisabledIcon = "Paste_Disabled", Shortcut = "Ctrl+Shift+V", OnClick = function()
			local sList = selection.List
			local newSelection = {}
			local count = 1
			for i = 1,#sList do
		...
		context:Register("DUPLICATE",{Name = "Duplicar", IconMap = Explorer.MiscIcons, Icon = "Copy", DisabledIcon = "Copy_Disabled", Shortcut = "Ctrl+D", OnClick = function()
			local clone = game.Clone
			local sList = selection.List
			local newSelection = {}
			local count = 1
		...
		context:Register("DELETE",{Name = "Excluir", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Del", OnClick = function()
		...
		context:Register("DELETE_CHILDREN",{Name = "Excluir Filhos", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Delete_Disabled", Shortcut = "Shift+Del", OnClick = function()
			local sList = selection.List
			for i = 1,#sList do
		...
		context:Register("RENAME",{Name = "Renomear", IconMap = Explorer.MiscIcons, Icon = "Rename", DisabledIcon = "Rename_Disabled", Shortcut = "F2", OnClick = function()
			local sList = selection.List
			if sList[1] then
		...
		context:Register("GROUP",{Name = "Agrupar", IconMap = Explorer.MiscIcons, Icon = "Group", DisabledIcon = "Group_Disabled", Shortcut = "Ctrl+G", OnClick = function()
			local sList = selection.List
		...
		context:Register("UNGROUP",{Name = "Desagrupar", IconMap = Explorer.MiscIcons, Icon = "Ungroup", DisabledIcon = "Ungroup_Disabled", Shortcut = "Ctrl+U", OnClick = function()
			local newSelection = {}
			local count = 1
			local isa = game.IsA
		...
		context:Register("SELECT_CHILDREN",{Name = "Selecionar Filhos", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "SelectChildren_Disabled", OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
		...
		context:Register("JUMP_TO_PARENT",{Name = "Ir para o Pai", IconMap = Explorer.MiscIcons, Icon = "JumpToParent", OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
		...
		context:Register("TELEPORT_TO",{Name = "Teletransportar Para", IconMap = Explorer.MiscIcons, Icon = "TeleportTo", OnClick = function()
			local sList = selection.List
		...
		local OldAnimation
		context:Register("PLAY_TWEEN",{Name = "Reproduzir Tween", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
			local sList = selection.List
		...
		local OldAnimation
		context:Register("LOAD_ANIMATION",{Name = "Carregar Animação", IconMap = Explorer.MiscIcons, Icon = "Play", OnClick = function()
			local sList = selection.List
		...
		context:Register("STOP_ANIMATION",{Name = "Parar Animação", IconMap = Explorer.MiscIcons, Icon = "Pause", OnClick = function()
			local sList = selection.List
		...
		context:Register("EXPAND_ALL",{Name = "Expandir Tudo", OnClick = function()
			local sList = selection.List
		...
		context:Register("COLLAPSE_ALL",{Name = "Recolher Tudo", OnClick = function()
			local sList = selection.List
		...
		context:Register("CLEAR_SEARCH_AND_JUMP_TO",{Name = "Limpar Busca e Ir para", OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
		...
		context:Register("COPY_PATH",{Name = "Copiar Caminho", IconMap = Explorer.LegacyClassIcons, Icon = 50, OnClick = function()
			local sList = selection.List
			if #sList == 1 then
		...
		context:Register("INSERT_OBJECT",{Name = "Inserir Objeto", IconMap = Explorer.MiscIcons, Icon = "InsertObject", OnClick = function()
		...
		context:Register("GET_REFERENCES",{Name = "Obter Referências Lua", IconMap = Explorer.ClassIcons, Icon = 34, OnClick = function()

		end})]]

		context:Register("SAVE_INST",{Name = "Salvar em Arquivo", IconMap = Explorer.MiscIcons, Icon = "Salvar", OnClick = function()
			local sList = selection.List
			if #sList == 1 then
		...
		context:Register("BLOCK_REMOTE",{Name = "Bloquear Disparo", IconMap = Explorer.MiscIcons, Icon = "Delete", DisabledIcon = "Empty", OnClick = function()
			local sList = selection.List
		...
		context:Register("UNBLOCK_REMOTE",{Name = "Desbloquear", IconMap = Explorer.MiscIcons, Icon = "Play", DisabledIcon = "Empty", OnClick = function()
			local sList = selection.List
			for i, list in sList do
				local obj = list.Obj
		...
		context:Register("COPY_API_PAGE",{Name = "Copiar URL da Página API Roblox", IconMap = Explorer.MiscIcons, Icon = "Reference", OnClick = function()
			local sList = selection.List
			if #sList == 1 then
				env.setclipboard(
		...
		context:Register("3DVIEW_MODEL",{Name = "Pré-visualizar Objeto 3D", IconMap = Explorer.LegacyClassIcons, Icon = 54, OnClick = function()
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("VIEW_OBJECT",{Name = "Ver Objeto (Clique direito para resetar)", IconMap = Explorer.LegacyClassIcons, Icon = 5, OnClick = function()
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("VIEW_SCRIPT",{Name = "Ver Script", IconMap = Explorer.MiscIcons, Icon = "ViewScript", DisabledIcon = "Empty", OnClick = function()
			local scr = selection.List[1] and selection.List[1].Obj
			if scr then ScriptViewer.ViewScript(scr) end
		end})
		context:Register("DUMP_FUNCTIONS",{Name = "Listar Funções", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "Empty", OnClick = function()
			local scr = selection.List[1] and selection.List[1].Obj
			if scr then ScriptViewer.DumpFunctions(scr) end
		end})

		context:Register("FIRE_TOUCHTRANSMITTER",{Name = "Disparar TouchTransmitter", OnClick = function()
		...
		context:Register("FIRE_CLICKDETECTOR",{Name = "Disparar ClickDetector", OnClick = function()
			local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
			if not hrp then return end
			for _, v in ipairs(selection.List) do if v.Obj and v.Obj:IsA("ClickDetector") then fireclickdetector(v.Obj) end end
		end})

		context:Register("FIRE_PROXIMITYPROMPT",{Name = "Disparar ProximityPrompt", OnClick = function()
			local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
			if not hrp then return end
		...
		context:Register("SAVE_SCRIPT",{Name = "Salvar Script", IconMap = Explorer.MiscIcons, Icon = "Salvar", DisabledIcon = "Empty", OnClick = function()
		...
		context:Register("SAVE_BYTECODE",{Name = "Salvar Bytecode do Script", IconMap = Explorer.MiscIcons, Icon = "Salvar", DisabledIcon = "Empty", OnClick = function()
			for _, v in next, selection.List do
				if v.Obj:IsA("LuaSourceContainer") and env.isViableDecompileScript(v.Obj) then
		...
		context:Register("SELECT_CHARACTER",{Name = "Selecionar Personagem", IconMap = Explorer.LegacyClassIcons, Icon = 9, OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("VIEW_PLAYER",{Name = "Ver Jogador", IconMap = Explorer.LegacyClassIcons, Icon = 5, OnClick = function()
			local newSelection = {}
			local count = 1
			local sList = selection.List
			local isa = game.IsA
		...
		context:Register("SELECT_LOCAL_PLAYER",{Name = "Selecionar Jogador Local", IconMap = Explorer.LegacyClassIcons, Icon = 9, OnClick = function()
			pcall(function() if nodes[plr] then selection:Set(nodes[plr]) Explorer.ViewNode(nodes[plr]) end end)
		end})

		context:Register("SELECT_ALL_CHARACTERS",{Name = "Selecionar Todos os Personagens", IconMap = Explorer.LegacyClassIcons, Icon = 2, OnClick = function()
			local newSelection = {}
			local sList = selection.List
		...
		context:Register("REFRESH_NIL",{Name = "Atualizar Instâncias Nulas", OnClick = function()
			Explorer.RefreshNilInstances()
		end})

		context:Register("HIDE_NIL",{Name = "Ocultar Instâncias Nulas", OnClick = function()
	...
	Explorer.InitInsertObject = function()
		...
		for i,class in next,API.Classes do
			...
			if not tags.NotCreatable and not tags.Service then
				...
				classes[#classes+1] = {class,rmdEntry and rmdEntry.ClassCategory or "Sem Categoria"}
			end
		end
...
return search]==]
		...
		local env = setmetatable({["searchResults"] = searchResults, ["nodes"] = nodes, ["Explorador"] = Explorer, ["specResults"] = specResults,
	...
	Explorer.Init = function()
		...
		local explorerItems = create({
			...
			{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Pesquisar workspace",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
...
local function main()
		...
		currentclickhandler = function()
			if type(codeToSave) == "string" then
				...
				if env.writefile then
					...
					if not s then
						win.Elements.Error.Text = "Erro: " .. msg
						task.spawn(error, msg)
						task.wait(1)
					end
				else
					win.Elements.Error.Text = "Seu executor não suporta 'writefile'"
					task.wait(1)
				end
	...
	Lib.ContextMenu = (function()
		...
		local function createGui(self)
			local contextGui = create({
				...
				{10,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="SearchBox",Parent={9},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Pesquisar",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-8,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
	...
	Lib.ColorPicker = (function() -- TODO: Convert to newer class model
		...
		local function new()
			...
			window:SetTitle("Seletor de Cor")
	...
	Lib.NumberSequenceEditor = (function()
		local function new() -- TODO: Convert to newer class model
			...
			window:SetTitle("Editor de NumberSequence")
			newMt.Window = window
			newMt.Gui = window.Gui
			for i,v in pairs(guiContents:GetChildren()) do
				v.Parent = window.GuiElems.Content
	...
	Lib.ColorSequenceEditor = (function() -- TODO: Convert to newer class model
		local function new()
			...
			window:SetTitle("Editor de ColorSequence")
			newMt.Window = window
			newMt.Gui = window.Gui
			for i,v in pairs(guiContents:GetChildren()) do
				v.Parent = window.GuiElems.Content
	...
	Lib.DropDown = (function()
			...
			if #options > 0 then
				if not self.Selected then
					if not self.CanBeEmpty then
						...
						self.GuiElems.Label.Text = "- Selecionar -"
					end
				else
		...
		funcs.SetOptions = function(self,opts)
			...
			if self.CanBeEmpty then
				context:Add({Name = "- Selecionar -", function() self.Selected = nil self.OnSelect:Fire(nil) self:Update() end})
			end
...
local function main()
	...
	ModelViewer.StopViewModel = function(updating)
		if updating then
			...
			window:SetTitle("Pré-visualização 3D")
			pathLabel.Gui.Text = ""
		end
	end
	...
	ModelViewer.ViewModel = function(item, updating)
		...
		if item ~= workspace and not item:IsA("Terrain") then
			...
			--[[if not item.PrimaryPart then
				pathLabel.Gui.Text = "Falha ao visualizar modelo: Nenhum PrimaryPart encontrado."
				return
			end]]
		...
		if not updating then
			...
			window:SetTitle(item.Name.." - Pré-visualização 3D")
			pathLabel.Gui.Text = "caminho: " .. getPath(originalModel)
			window:Show()
	...
	ModelViewer.Init = function()
		...
		-- Registers
		context:Register("STOP",{Name = "Parar Visualização", OnClick = function()
			ModelViewer.StopViewModel()
		end})
		context:Register("EXIT",{Name = "Sair", OnClick = function()
			ModelViewer.StopViewModel()
			context:Hide()
			window:Hide()
		end})
		context:Register("COPY_PATH",{Name = "Copiar Caminho", OnClick = function()
			if model then
				env.setclipboard(getPath(originalModel))
			end
		end})
		context:Register("REFRESH",{Name = "Atualizar", OnClick = function()
			if originalModel then
				ModelViewer.ViewModel(originalModel)
			end
		end})
		context:Register("ENABLE_AUTO_REFRESH",{Name = "Ativar Atualização Automática", OnClick = function()
			if originalModel then
				ModelViewer.AutoRefresh = true
				ModelViewer.ViewModel(originalModel)
			end
		end})
		context:Register("DISABLE_AUTO_REFRESH",{Name = "Desativar Atualização Automática", OnClick = function()
			if originalModel then
				ModelViewer.AutoRefresh = false
				ModelViewer.ViewModel(originalModel)
			end
		end})
		context:Register("SAVE_INST",{Name = "Salvar em Arquivo", OnClick = function()
			if model then
				Lib.SaveAsPrompt("Place_"..game.PlaceId.."_"..originalModel.Name.."_"..os.time(), function(filename)
					window:SetTitle(originalModel.Name.." - Visualizador de Modelo - Salvando")	
					...
					if success then
						window:SetTitle(originalModel.Name.." - Visualizador de Modelo - Salvo")
						context:Hide()
						task.wait(5)
						if model then
							window:SetTitle(originalModel.Name.." - Visualizador de Modelo")
						end
					else
						window:SetTitle(originalModel.Name.." - Visualizador de Modelo - Erro")
						warn("Erro ao salvar modelo: "..result)
						context:Hide()
						task.wait(5)
						if model then
							window:SetTitle(originalModel.Name.." - Visualizador de Modelo")
		...
		context:Register("ENABLE_AUTO_ROTATE",{Name = "Ativar Rotação Automática", OnClick = function()
			ModelViewer.AutoRotate = true
			
		end})
		context:Register("DISABLE_AUTO_ROTATE",{Name = "Desativar Rotação Automática", OnClick = function()
			ModelViewer.AutoRotate = false
		end})
		context:Register("LOCK_CAM",{Name = "Travar Câmera", OnClick = function()
			ModelViewer.EnableInputCamera = false
		end})
		context:Register("UNLOCK_CAM",{Name = "Destravar Câmera", OnClick = function()
			ModelViewer.EnableInputCamera = true
		end})
		
		context:Register("ZOOM_IN",{Name = "Aumentar Zoom", OnClick = function()
			distance = math.clamp(distance - (ModelViewer.ZoomMultiplier * 2), 2, math.huge)
		end})
		
		context:Register("ZOOM_OUT",{Name = "Diminuir Zoom", OnClick = function()
			distance = math.clamp(distance + (ModelViewer.ZoomMultiplier * 2), 2, math.huge)
		end})
...
local function main()
	...
	Properties.DisplayAttributeContext = function(prop)
		...
		context:Add({Name = "Excluir", OnClick = function()
	...
	Properties.DisplayAddAttributeWindow = function(editAttr)
		...
		if not win then
			...
			win.Alignable = false
			win.Resizable = false
			win:SetTitle("Adicionar Atributo")
			win:SetSize(200,130)
			...
			saveButton.OnClick:Connect(function()
				...
				if #name > 100 then
					errorLabel.Text = "Erro: Nome com mais de 100 caracteres"
					return
				elseif name:sub(1,3) == "RBX" then
					errorLabel.Text = "Erro: Nome começa com 'RBX'"
					return
				end
		...
		win:SetTitle(editAttr and "Editar Atributo "..editAttr.AttributeName or "Adicionar Atributo")
		win.Elements.Error.Text = ""
	...
	Properties.InitEntryStuff = function()
		Properties.EntryTemplate = create({
			...
			{26,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderSizePixel=0,Font=3,Name="RowButton",Parent={1},Size=UDim2.new(1,0,1,0),Text="Adicionar Atributo",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,Visible=false,}},
...
local function main()
	...
	SaveInstance.Init = function()
		window = Lib.Window.new()
		window:SetTitle("Salvar Instância")
		...
		local Decompile = AddCheckbox("Decompilar Scripts (LocalScript e ModuleScript)", SaveInstanceArgs.Decompile)
		Decompile.OnInput:Connect(function()
			SaveInstanceArgs.Decompile = Decompile.Toggled
		end)
		
		local decompileTimeout = AddTextbox("Tempo Limite de Decompilação (s)", SaveInstanceArgs.DecompileTimeout, 15)
		...
		local decompileThread = AddTextbox("Máximo de Threads do Decompilador", "3", 15)
		decompileThread.TextBox.FocusLost:Connect(function()
			SaveInstanceArgs.MaxThreads = tonumber(decompileThread.TextBox.Text)
		end)
		
		local decompileIgnore = AddTextbox("Ignorar na Decompilação", table.concat(SaveInstanceArgs.DecompileIgnore, ","), 50)
		...
		local NilObj = AddCheckbox("Salvar Instâncias Nulas", SaveInstanceArgs.NilInstances)
		NilObj.OnInput:Connect(function()
			SaveInstanceArgs.NilInstances = NilObj.Toggled
		end)

		local RemovePlayerChar = AddCheckbox("Remover Personagens dos Jogadores", SaveInstanceArgs.RemovePlayerCharacters)
		RemovePlayerChar.OnInput:Connect(function()
			SaveInstanceArgs.RemovePlayerCharacters = RemovePlayerChar.Toggled
		end)
		
		local SavePlayerObj = AddCheckbox("Salvar Instância do Jogador", SaveInstanceArgs.SavePlayers)
		SavePlayerObj.OnInput:Connect(function()
			SaveInstanceArgs.SavePlayers = SavePlayerObj.Toggled
		end)
		
		local IsolateStarterPlr = AddCheckbox("Isolar StarterPlayer", SaveInstanceArgs.IsolateStarterPlayer)
		IsolateStarterPlr.OnInput:Connect(function()
			SaveInstanceArgs.IsolateStarterPlayer = IsolateStarterPlr.Toggled
		end)
		
		local IgnoreDefaultProps = AddCheckbox("Ignorar Propriedades Padrão", SaveInstanceArgs.IgnoreDefaultProps)
		IgnoreDefaultProps.OnInput:Connect(function()
			SaveInstanceArgs.IgnoreDefaultProps = IgnoreDefaultProps.Toggled
		end)
		
		local ShowStat = AddCheckbox("Mostrar Status", SaveInstanceArgs.ShowStatus)
		...
		Button.MouseButton1Click:Connect(function()
			...
			window:SetTitle("Salvar Instância - Salvando")
			local s, result = pcall(env.saveinstance, game, fileName, SaveInstanceArgs)
			if s then
				window:SetTitle("Salvar Instância - Salvo")
			else
				window:SetTitle("Salvar Instância - Erro")
				task.spawn(error("Falha ao salvar o jogo: "..result))
			end
			task.wait(5)
			window:SetTitle("Salvar Instância")
...
local function main()
	...
	ScriptViewer.Init = function()
		window = Lib.Window.new()
		window:SetTitle("Bloco de Notas")
		window:Resize(500,400)
		...
		copy.Text = "Copiar para Área de Transferência"
	...
	ScriptViewer.ViewScript = function(scr)
		...
		if not s or not source then
			PreviousScr = nil
			dumpbtn.TextColor3 = Color3.new(0.5,0.5,0.5)
			source = "-- Não foi possível visualizar o código-fonte.\n"
			
			if Settings.ScriptViewer.ShowMoreInfo then
				source = source .. "-- Caminho do Script: "..getPath(scr).."\n"
				if (scr.ClassName == "Script" and (scr.RunContext == Enum.RunContext.Legacy or scr.RunContext == Enum.RunContext.Server)) or not scr:IsA("LocalScript") then
					source = source .. "-- Motivo: O script não está rodando no cliente. (tentativa de decompilar ServerScript ou 'Script' com RunContext Server)\n"
				elseif not env.isdecompile() then
					source = source .. "-- Motivo: Seu executor não suporta decompilador. (falta a função 'decompile' e a função 'getscriptbytecode' como fallback)\n"
				else
					source = source .. "-- Motivo: Erro desconhecido.\n"
				end
			...
			source = "-- Caminho do Script: "..getPath(scr).."\n"
			
			if Settings.ScriptViewer.ShowMoreInfo then
				source = source .. "-- Levou "..tostring(math.floor( (tick() - oldtick) * 100) / 100).."s para decompilar.\n"
				source = source .. "-- Executor: "..executorName.." ("..executorVersion..")\n\n"
			end
...
local function main()
	...
	SettingsWindow.ReloadPrompt = function()		
		...
		if not win then
			...
			win.Alignable = false
			win.Resizable = false
			win:SetTitle("Aplicar Configurações Atuais")
			win:SetSize(300,115)

			local reloadButton = Lib.Button.new()
			local nameLabel = Lib.Label.new()
			nameLabel.Text = "Aplicar as configurações atuais requer reinicialização.\nQualquer progresso não salvo será perdido.\nTem certeza?"
			...
			local cancelButton = Lib.Button.new()
			cancelButton.AnchorPoint = Vector2.new(1,1)
			cancelButton.Text = "Aplicar Depois"
			cancelButton.Position = UDim2.new(1,-5,1,-5)
			cancelButton.Size = UDim2.new(0.5,-10,0,20)
			cancelButton.OnClick:Connect(function()
				win:Close()
			...
			reloadButton.Text = "Aplicar Agora"
	...
	SettingsWindow.Init = function()
		...
		AddSeperator("Interface")
		
		local titleonmiddle = AddCheckbox("Título da Janela no Centro", Settings.Window.TitleOnMiddle)
		titleonmiddle.OnInput:Connect(function()
			Settings.Window.TitleOnMiddle = titleonmiddle.Toggled
		end)
		
		local bgTransparency = AddTextbox("Transparência do Fundo", tostring(Settings.Window.Transparency), 15)
		bgTransparency.FocusLost:Connect(function()
			Settings.Window.Transparency = tonumber(bgTransparency.Text)
		end)
		
		local classIcon = AddDropdown("Ícones de Classe", {"Old", "NewDark", "Vanilla3"}, Settings.ClassIcon, false, 100)
		classIcon.OnSelect:Connect(function()
			Settings.ClassIcon = classIcon.Selected
		end)
		
		AddSeperator("Explorador")
		
		local clickRename = AddCheckbox("Clique para Renomear", Settings.Explorer.ClickToRename)
		clickRename.OnInput:Connect(function()
			Settings.Explorer.ClickToRename = clickRename.Toggled
		end)
		
		local partSelectionBox = AddCheckbox("Caixa de Seleção de Peça", Settings.Explorer.PartSelectionBox)
		partSelectionBox.OnInput:Connect(function()
			Settings.Explorer.PartSelectionBox = partSelectionBox.Toggled
		end)
		
		local copypathUseChildren = AddCheckbox("Usar GetChildren para Copiar Caminho", Settings.Explorer.CopyPathUseGetChildren)
		copypathUseChildren.OnInput:Connect(function()
			Settings.Explorer.CopyPathUseGetChildren = copypathUseChildren.Toggled
		end)
		
		AddSeperator("Propriedades")

		local showDeprecated = AddCheckbox("Mostrar Depreciados", Settings.Properties.ShowDeprecated)
		showDeprecated.OnInput:Connect(function()
			Settings.Properties.ShowDeprecated = showDeprecated.Toggled
		end)
		
		local showHidden = AddCheckbox("Mostrar Ocultos", Settings.Properties.ShowHidden)
		showHidden.OnInput:Connect(function()
			Settings.Properties.ShowHidden = showHidden.Toggled
		end)
		
		local showAttributes = AddCheckbox("Mostrar Atributos", Settings.Properties.ShowAttributes)
		showAttributes.OnInput:Connect(function()
			Settings.Properties.ShowAttributes = showAttributes.Toggled
		end)
		local clearOnFocus = AddCheckbox("Limpar ao Focar", Settings.Properties.ClearOnFocus)
		clearOnFocus.OnInput:Connect(function()
			Settings.Properties.ClearOnFocus = clearOnFocus.Toggled
		end)
		
		AddSeperator("Visualizador de Script")
		
		local showMoreInfo = AddCheckbox("Mostrar Info do Script Decompilado", Settings.ScriptViewer.ShowMoreInfo)
		showMoreInfo.OnInput:Connect(function()
			Settings.ScriptViewer.ShowMoreInfo = showMoreInfo.Toggled
		end)
		
		AddSeperator("Decompilador")
		AddText("Se o executor não suportar decompilação, será usada a opção de fallback.")
		AddText("'getbytecode' é obrigatório para usar decompiladores de fallback.")
		local decompilerOption = {"Konstant", "AdvancedDecompiler", "Shiny"}
		local decompiler = AddDropdown("Decompilador de Fallback", decompilerOption, Settings.Decompiler.DecompilerFallback, false, 125)
		decompiler.OnSelect:Connect(function()
			Settings.Decompiler.DecompilerFallback = decompiler.Selected
		end)
		
		local ShinyPort = AddTextbox("Porta do Decompilador Shiny", tostring(Settings.Decompiler.ShinyDecompilerPort), 50)
		...
		local preferFallback = AddCheckbox("Preferir Decompilador de Fallback", Settings.Decompiler.PreferDecompilerFallback)
		...
		LabelreloadButton.Gui.Text = "Reiniciar"
		...
		reloadButton.MouseButton1Click:Connect(function()
			window:SetTitle("Configurações - Salvando")
			
			Main.SaveCurrentSettings()
			
			window:SetTitle("Configurações - Salvo")
...
Main = (function()
	...
	Main.ModuleList = {"Explorador","Propriedades","ScriptViewer","Console","SaveInstance","ModelViewer","SettingsWindow"}
	Main.Elevated = false
	...
	Main.IncompatibleTest = function()
		--[[local function incompatibleMessage(reason, tolerated)
			...
			t.TextWrapped = true
			t.TextScaled = true
			t.Text = "\n\n\n\n\n\n\n\nOlá usuário de Skidsploit,\nZinnia, Chillz e o Secret Service não aprovam o uso do Dex no seu skidsploit.\nPor favor considere usar algo melhor.\n\nMotivo de Incompatibilidade: "..reason.."\n\n\n\n\n\n\n\n"
	...
	Main.FetchRMD = function()
		...
		for _,class in pairs(classList) do
			...
			for _,child in pairs(class.children) do
				if child.tag == "Propriedades" then
				...
				elseif child.attrs.class == "ReflectionMetadataProperties" then
					...
					for _,member in pairs(members) do
						if member.attrs.class == "ReflectionMetadataMember" then
							local data = {}
							if member.children[1].tag == "Propriedades" then
		...
		for _,enum in pairs(enumList) do
			...
			for _,child in pairs(enum.children) do
				...
				elseif child.attrs.class == "ReflectionMetadataEnumItem" then
					local data = {}
					if child.children[1].tag == "Propriedades" then
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Suite Definitiva de Depuração",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
			{7,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,110),Size=UDim2.new(0,180,0,25),Text="Obtendo API",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Desenvolvido por Chillz.",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "Fechar" or "Dex++"
	...
	Main.CreateMainGui = function()
		local gui = create({
			...
			{10,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Configurações",Parent={6},Position=UDim2.new(1,-48,0,0),Size=UDim2.new(0,24,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
			...
			{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="AppName",Parent={18},Position=UDim2.new(0,2,0,38),Size=UDim2.new(1,-4,1,-40),Text="Explorador",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,TextTruncate=1,TextWrapped=true,TextYAlignment=0,}},
		...
		openButton.MainFrame.BottomFrame.Information.MouseButton1Click:Connect(function()
			...
			if not infoDexIntro then
				infoDexIntro = Main.CreateIntro("Executando")
				--Main.AppControls ~= {}
				coroutine.wrap(function()
		...
		-- Create Main Apps
		Main.CreateApp({Name = "Explorador", IconMap = Main.LargeIcons, Icon = "Explorador", Open = true, Window = Explorer.Window})

		Main.CreateApp({Name = "Propriedades", IconMap = Main.LargeIcons, Icon = "Propriedades", Open = true, Window = Properties.Window})

		local cptsOnMouseClick = nil
		Main.CreateApp({Name = "Clique na peça para selecionar", IconMap = Explorer.ClassIcons, Icon = "SelectionBox", OnClick = function(callback)
			if callback then
				local mouse = Main.Mouse
		...
		Main.CreateApp({Name = "Bloco de Notas", IconMap = Main.LargeIcons, Icon = "Script_Viewer", Window = ScriptViewer.Window})
		
		Main.CreateApp({Name = "Console", IconMap = Main.LargeIcons, Icon = "Executor", Window = Console.Window})
		
		Main.CreateApp({Name = "Salvar Instância", IconMap = Main.LargeIcons, Icon = "Book", Window = SaveInstance.Window})
		
		Main.CreateApp({Name = "Visualizador 3D", IconMap = Main.LargeIcons, Icon = "Object", Window = ModelViewer.Window})
	...
	Main.Init = function()
		...
		-- Load Lib
		local intro = Main.CreateIntro("Inicializando Biblioteca")
		...
		--[[ Loading bypasses
		intro.SetProgress("Carregando Bypass do Adonis",0.1)
		pcall(Main.LoadAdonisBypass)
		
		intro.SetProgress("Carregando Bypass GC",0.2)
		pcall(Main.LoadGCBypass)]]

		-- Fetch version if needed
		intro.SetProgress("Obtendo Versão do Roblox",0.3)
		if Main.Elevated then
		...
		-- Fetch external deps
		intro.SetProgress("Obtendo API",0.35)
		API = Main.FetchAPI(
			function()
				intro.SetProgress("Obtendo API, Por Favor Aguarde.",0.4)
			end,
			function()
				intro.SetProgress("Obtendo API, Aguarde Devido ao Grande Arquivo da API.",0.45)
			end,
			function()
				intro.SetProgress("Obtendo API, AINDA BAIXANDO? wifi ruim kk",0.475)
			end
		)
		Lib.FastWait()
		intro.SetProgress("Obtendo RMD",0.5)
		RMD = Main.FetchRMD()
		Lib.FastWait()
		...
		-- Load other modules
		intro.SetProgress("Carregando Módulos",0.75)
		Main.AppControls.Lib.InitDeps(Main.GetInitDeps()) -- Missing deps now available
		Main.LoadModules()
		Lib.FastWait()

		-- Init other modules
		intro.SetProgress("Inicializando Módulos",0.8)
		Explorer.Init()
		Properties.Init()
		ScriptViewer.Init()
		Console.Init()
		...
		if env.readfile and listfiles then
			if #listfiles("dex/plugins") > 0 then
				intro.SetProgress("Carregando Arquivos de Plugin",0.8)
				for _, pluginDir in pairs(listfiles("dex/plugins")) do
					...
					local pluginFriendlyName = moduleData.PluginData.FriendlyName or moduleData.Window.GuiElems.Title.Text or "Plugin Sem Nome"
					local pluginName = moduleData.PluginData.Name or moduleData.Window.GuiElems.Title.Text:gsub(" ", "") or "unnamedPlugin"

					intro.SetProgress("Inicializando Plugin: ".. pluginFriendlyName,0.9)
...
local function main()
	...
	local function push_row(entry)
		...
		dl.Text = (entry.dir == "out" and "saída" or "entrada") .. "  [" .. entry.class .. "]"
	...
	local function add_log(dir, inst, method, raw_args)
		...
		if status_label then
			status_label.Text = #logs .. " registros"
		end
	end
	...
	spy.Init = function()
		...
		local start_btn = make_btn(toolbar, "▶ iniciar",  2,  58)
		local stop_btn  = make_btn(toolbar, "■ parar",   64, 50)
		local clear_btn = make_btn(toolbar, "limpar",   118, 42)
		local pause_btn = make_btn(toolbar, "pausar",   164, 42)
		local copy_btn  = make_btn(toolbar, "copiar tudo",210, 58)
		...
		search_box.PlaceholderText  = "filtrar…"
		...
		pause_btn.MouseButton1Click:Connect(function()
			paused = not paused
			pause_btn.Text = paused and "continuar" or "pausar"
...
local function InitAdonisBypass()
	...
	if not getreg or not getgc or not isfunctionhooked then
		warn("O executor não suporta funções de bypass do Adonis.")
		return false
	end
...
b.Position = UDim2.new(1,-190,1,-50)
b.Text = "DEX++ PT-BR"
b.Parent = sg
end)
